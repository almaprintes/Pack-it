(()=>{
const VERSION='DEV 0.0.62';
document.querySelectorAll('.version,.splash-version').forEach(e=>e.textContent=VERSION);
const music=new Audio('assets/audio/music-cozy-jazz-v1.mp3?v=0062');
...
function nextBoxSound(){clearTimeout(restoreTimer);stopChime();fadeMusic(.18,180);boxSlide()}
